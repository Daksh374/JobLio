        ...
        <div>
            ...
            <div className='flex items-center justify-center mx-auto min-h-[80vh]'>
                <form onSubmit={submitHandler} className='w-full sm:w-2/3 md:w-1/2 lg:w-1/3 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border border-gray-100 dark:border-gray-800 rounded-3xl p-8 my-10 shadow-2xl hover:shadow-primary/10 transition-shadow duration-300'>
                    <h1 className='font-extrabold text-3xl mb-8 text-center text-gray-800 dark:text-gray-100'>Welcome Back</h1>
                    <div className='my-4'>
                        <Label>Email</Label>
                        <Input
                            type="email"
                    ...
                    </div>
                    {
                        ...
                        : <Button type="submit" className="w-full my-6 bg-primary hover:bg-primary/90 text-white rounded-full p-6 text-lg font-medium shadow-lg shadow-primary/25 transition-all duration-300">Login</Button>
                    }
                    <div className='text-center'>
                        <span className='text-sm text-gray-600'>Don't have an account? <Link to="/signup" className='text-primary hover:underline font-semibold'>Signup</Link></span>
                    </div>
                </form>
            </div>
        </div>
